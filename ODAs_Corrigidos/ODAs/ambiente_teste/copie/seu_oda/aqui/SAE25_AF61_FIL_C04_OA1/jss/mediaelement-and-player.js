...
Object.assign(_player2.default.prototype, {
	...
	buildfullscreen: function buildfullscreen(player) {
		...
		fullscreenBtn.innerHTML = '<button type="button" aria-controls="' + t.id + '" aria-label="' + fullscreenTitle + '" tabindex="0"></button>';
	...
	enterFullScreen: function enterFullScreen() {
		$('.btX , .navDir , .navEsq , .navegacao .btNav').attr('tabindex','-1');
		var t = this,
	...
	exitFullScreen: function exitFullScreen() {
		$('.btX , .navDir , .navEsq , .navegacao .btNav').removeAttr('tabindex');
		var t = this,
		    isNative = t.media.rendererName !== null && /(native|html5)/i.test(t.media.rendererName);
...
Object.assign(_player2.default.prototype, {
	buildplaypause: function buildplaypause(player, controls, layers, media) {
		...
		play.innerHTML = '<button type="button" aria-controls="' + t.id  + '" aria-label="' + pauseTitle + '" tabindex="0"></button>';
...
Object.assign(_player2.default.prototype, {
	buildprogress: function buildprogress(player, controls, layers, media) {
		...
		rail.innerHTML = '<div class="' + t.options.classPrefix + 'time-total ' + t.options.classPrefix + 'time-slider">' + ('<span class="' + t.options.classPrefix + 'time-buffering"></span>') + ('<span class="' + t.options.classPrefix + 'time-loaded"></span>') + ('<span class="' + t.options.classPrefix + 'time-current"></span>') + ('<span class="' + t.options.classPrefix + 'time-hovered no-hover"></span>') + ('<span class="' + t.options.classPrefix + 'time-handle"><span class="' + t.options.classPrefix + 'time-handle-content"></span></span>') + ('' + tooltip) + '</div>';
...
Object.assign(_player2.default.prototype, {
	...
	buildtracks: function buildtracks(player, controls, layers, media) {
		...
		player.chaptersButton.innerHTML = '<button type="button" aria-controls="' + t.id + '" aria-label="' + chaptersTitle + '" tabindex="0"></button>' + ('<div class="' + t.options.classPrefix + 'chapters-selector ' + t.options.classPrefix + 'offscreen">') + ('<ul class="' + t.options.classPrefix + 'chapters-selector-list"></ul>') + '</div>';
...
Object.assign(_player2.default.prototype, {
	buildvolume: function buildvolume(player, controls, layers, media) {
		...
		mute.innerHTML = mode === 'horizontal' ? '<button type="button" aria-controls="' + t.id + '" aria-label="' + muteText + '" tabindex="0"></button>' : '<button type="button" aria-controls="' + t.id + '" aria-label="' + muteText + '" tabindex="0"></button>' + ('<div tabindex="0" class="' + t.options.classPrefix + 'volume-slider" ') + ('aria-label="' + _i18n2.default.t('mejs.volume-slider') + '" aria-valuemin="0" aria-valuemax="100" ') + 'aria-orientation="vertical">' + ('<span class="' + t.options.classPrefix + 'offscreen">' + volumeControlText + '</span>') + ('<div class="' + t.options.classPrefix + 'volume-total">') + ('<div class="' + t.options.classPrefix + 'volume-current"></div>') + ('<div class="' + t.options.classPrefix + 'volume-handle"></div>') + '</div>' + '</div>';
...
var EN = exports.EN = {
	...
	"mejs.time-slider": "Controle de tempo deslizante",
	...
	"mejs.unmute": "Unmute",
	"mejs.mute": "Mute",
	"mejs.volume-slider": "Controle de volume deslizante",
